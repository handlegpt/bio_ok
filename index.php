...
header('Content-Security-Policy: default-src \'self\'; script-src \'self\' \'unsafe-inline\' https://cdn.jsdelivr.net https://www.googletagmanager.com; style-src \'self\' \'unsafe-inline\' https://cdn.jsdelivr.net https://cdnjs.cloudflare.com; img-src \'self\' data: https://api.qrserver.com; font-src \'self\' https://cdnjs.cloudflare.com; connect-src \'self\' https://api.weatherapi.com https://wttr.in https://ipapi.co https://ipinfo.io http://ip-api.com https://api.bigdatacloud.net https://api.openweathermap.org https://httpbin.org https://api.github.com https://jsonplaceholder.typicode.com https://www.random.org https://api.qrserver.com https://cdn.jsdelivr.net https://date.nager.at https://holidays.abstractapi.com https://api.calendario.com.br https://www.google-analytics.com https://analytics.google.com https://speed.cloudflare.com; frame-ancestors \'none\';');
?>
<!DOCTYPE html>
<html lang="en">
<head>
        ...
        <div class="container py-3">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div class="d-flex align-items-center gap-3">
                    <!-- 主题切换按钮 -->
                    <button type="button" class="btn btn-sm btn-outline-secondary" id="theme-toggle" title="切换主题">
